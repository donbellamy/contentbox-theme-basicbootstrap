...
<link rel="stylesheet" href="#cb.themeRoot()#/includes/css/bootstrap.min.css">
<link rel="stylesheet" href="#cb.themeRoot()#/includes/css/theme.css">
...
<!--- ********************************************************************************* --->
<!-- injector:js -->
<script src="#cb.themeRoot()#/includes/js/theme.js"></script>
<!-- endinjector -->
</cfoutput>